...
//		super();	// NOTE JKris if you don't call parent's constructor in a child class' constructor, java will automagically call default constructor of parent
	}
	...
	public DivideOperatorFor2numbers(float _number1, float number2) {
		...
		System.out.println("\nparent's number1 is " + super.number1);
